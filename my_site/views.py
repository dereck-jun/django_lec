...
def index(request):
  ...
  return render(request, 'my_site/content_list.html', context)

def detail(request, content_id):
  content_list = get_object_or_404(MainContent, pk=content_id)
  context = {'content_list': content_list}
  return render(request, 'my_site/content_detail.html', context)
...
def comment_update(request, comment_id):
  ...
  return render(request, 'my_site/comment_form.html', context)
